...
Write-Host ""
Write-Host "Two services:"
Write-Host "  nova dashboard"
Write-Host "  `$env:NOVA_COORDINATOR_URL='http://<lan-ip>:8080'; nova worker"
Write-Host "  .\scripts\install-service.ps1 dashboard"
Write-Host "  .\scripts\install-service.ps1 worker"
Write-Host ""
